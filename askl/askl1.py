...
def main(ds, time_factor, seed):
    ...
    run_dir = pjoin(ROOT, "askl", "askl1_results", ds)
    ...
    dump_pickle(automl, f"askl1_results/{ds}/askl_obj.pkl")
    ...
    best_pipeline_summary.update(
        get_best_askl_pipeline(best_pipeline_id, ds, seed, askl1=True))

    print("Saving best pipeline summary...")

    dump_json(best_pipeline_summary, f"askl1_results/{ds}/best_pipeline_summary.json")
